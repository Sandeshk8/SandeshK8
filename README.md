...
I am a passionate backend developer who treats coding like a playground. I specialize in building robust, high-throughput server architectures, securing data pipelines, and designing intelligent AI agent systems. When I'm not optimizing queries or designing microservices, you can find me automating my surroundings or contributing to open-source ecosystems.

- 🌍 **Where I am:** Based in India.
- 🧠 **What I'm up to:** Deep-diving into Low-Level Design (LLD), High-Level Design (HLD), scaling high-concurrency systems, and mastering AI Agent Harnessing.
- 🤝 **Collaboration:** Open to collaborating on open-source tools, performance optimization challenges, or AI/Agentic workflows.
...
* **Sidequests Ecosystem:** Architected a high-concurrency event-booking backend from scratch[cite: 1, 14, 16]. Solved the classic overbooking nightmare by implementing a strict custom payment flow with pessimistic seat locking and lazy booking expiries[cite: 1, 19].
* **Xeno (Discord Bot & Game Engine):** Built a modular Discord bot featuring an asynchronous, channel-isolated Word Chain game engine[cite: 1, 20, 22, 23]. It comes with custom anti-trap heuristics to evaluate tough English language edge cases in real-time[cite: 1, 23].
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Sandeshk8&layout=compact&theme=tokyonight&hide_border=true&langs_count=6" alt="Top Languages" width="52%" />
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=Sandeshk8&theme=tokyonight&hide_border=true" alt="GitHub Streak" width="46%" />
</p>
...
* **Three-Time Ultimate Team Player:** Recognized multiple times in my professional career for bridging gaps between development, leadership, and operational stability[cite: 1, 4, 31].
* **Mentorship:** Led the "Ciphers" Coding Club as head mentor, breaking down complex data structures, Java, and Git workflows for over 100+ junior devs[cite: 1, 34].

---

## 🌐 Connect With Me

Let's talk system design, AI agents, or system automation!

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/sandesh-kadamx/)
